      ...
      <!doctype html>
          ...
          <head>
              ...
              table[class=body] .main {
                  ...
                  border-radius: 0 !impexpiresortant;
                  ...
                  <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
                      ...
                      <tr>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                              ...
                              <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                  ...
                                  <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">・ Expires in 24hr</p>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                          ...
                          <td class="content-block" style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; font-size: 12px; color: #999999; text-align: center;">
                              <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">EaseShare inc. main street 29, Moscow</span>
                              <br> Want to share a file? <a href="https://anandk008.github.io/easeShare/" style="text-decoration: underline; color: #999999; font-size: 12px; text-align: center;">EaseShare</a>.
                          </td>
                          </tr>
                      </table>
                      </div>
